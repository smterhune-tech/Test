...
const FUB_SOURCE_NAME = process.env.FUB_SOURCE_NAME || "Terhune Realty Partners Website";
...
const LEAD_TYPE_MAP = {
  ...
  lead_magnet: { type: "Registration", message: () => "Requested the Austin Relocation & Buyer's Guide." }
};
